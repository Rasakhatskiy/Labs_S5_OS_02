...
public class Scheduling {
    ...
    private static void debug() {
        ...
        for (i = 0; i < size; i++) {
            ...
            System.out.println("process " + i + " " + process.cputime + " " + process.ioblocking + " " + process.cputimeDone + " " + process.numblocked);
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (i = 0; i < processVector.size(); i++) {
                ...
                out.print(Integer.toString(process.cputimeDone));
                if (process.cputimeDone < 100) {
                    out.print(" (ms)\t\t");
                } else {
                    out.print(" (ms)\t");
                }
    ...
    public static void sort(List<sProcess> itemLocationList) {
        Collections.sort(itemLocationList, new Comparator<sProcess>() {
            @Override
            public int compare(sProcess o1, sProcess o2) {

                if (o1.finishedNumber < o2.finishedNumber) {
                    return -1;
                }
                if (o1.finishedNumber > o2.finishedNumber) {
                    return 1;
